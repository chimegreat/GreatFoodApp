...
const SearchScreen = () => {
  ...
  const performSearch = async(query) => {
    ...
    // search by name first, then by ingreident if no results
    ...
    const loadInitialData = async () => {
      try {
        ...
        setRecipes(results)
                  ...
                  console.error("Error loading intiial data : ", error);
      }finally{
          ...
          <TextInput
            ...
            {searchQuery.length > 0 && (
              <TouchableOpacity onPress={ () => setSearchQuery(" ")} style={searchStyles.clearButton}>
                <Ionicons name='close-circle' size={20} COLORS={COLORS.textLight} />
