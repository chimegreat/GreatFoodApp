...
const RecipeDetialScreen = () => {
 ...
 const userId = user?.id
  ...
  const getYoutubeEmbedUrl = (url) =>{
    const videoId = url.split("v=")[1] //get secondpart of a video
      ...
      />
        <View style={recipeDetailStyles.floatingButtons}>
          <TouchableOpacity
            ...
            onPress={() => router.back()}
          >
            <Ionicons name="arrow-back" size={24} colors={COLORS.white} />
          </TouchableOpacity>
  ...
  <View style={recipeDetailStyles.statsContainer}>
      ...
      <View style={recipeDetailStyles.sectionContainer}> 
        ...
        >
        <Ionicons names="List" size={16} color={COLORS.white} />
        </LinearGradient>
        <Text style={recipeDetailStyles.sectionTitle}>Ingredientss</Text>
    ...
    <View style={recipeDetailStyles.sectionContainer}>
      <View style={recipeDetailStyles.sectionTitleRow}> 
        <LinearGradient 
              ...
              style={recipeDetailStyles.sectionIcon}
        >
        <Ionicons names="book" size={16} color={COLORS.white} />
        </LinearGradient>
